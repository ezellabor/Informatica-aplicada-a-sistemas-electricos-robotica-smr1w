...
## Pregunta 1: El robot aspirador hipotético
...
* **b)** ¿Qué **actuadores** (elementos que realizan una acción física) llevaría para poder realizar su tarea? (Nombra al menos 2 tipos)

---

## Pregunta 2: De lo cotidiano a la robótica
...
* **b)** ¿Qué elemento actúa como **actuador** para realizar la acción de abrir la puerta?
* **c)** ¿Qué pasaría si se avería el sensor? ¿Y si se avería el actuador?

---

## Pregunta 3: Diferenciando conceptos clave
...
* **b)** Siguiendo esa lógica, ¿cómo clasificarías una **pantalla táctil**? ¿Es sensor, actuador o ambos? Explica tu respuesta.

---

## Pregunta 4: El caso del semáforo con botón para peatones
...
* **b)** Identifica y nombra los **actuadores** principales (hay más de uno)
* **c)** Describe de forma muy sencilla la **secuencia lógica**: ¿Qué información capta el sensor y qué acciones realizan los actuadores en respuesta?

---

## Pregunta 5: Reflexión: Sentidos y músculos de un robot
...
* **b)** Para ese mismo brazo, ¿qué "músculos" (actuadores) utilizaría para mover sus articulaciones y su pinza?