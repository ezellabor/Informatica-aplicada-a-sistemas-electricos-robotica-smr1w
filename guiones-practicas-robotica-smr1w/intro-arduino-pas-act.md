...
## 1. Conceptos previos  
### Componentes Pasivos    
- No generan energía ni controlan el flujo mediante señales externas.
- Ejemplo: **Resistencia** (limita la corriente).  

### Componentes Activos  
- Pueden controlar el flujo eléctrico o proporcionar ganancia.
- Ejemplos: **LED** (semiconductor) y **Arduino** (microcontrolador).  
