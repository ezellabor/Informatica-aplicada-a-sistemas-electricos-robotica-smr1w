...
# Anatomía de Arduino: El Hardware 
...
| `Pines digitales 0–13` | 14 pines I/O | *Entradas y salidas digitales configurables mediante pinMode(), digitalRead() y digitalWrite().* |
